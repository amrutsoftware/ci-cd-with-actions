[![React App CI](https://github.com/amrutsoftware/ci-cd-with-actions/actions/workflows/ci.yml/badge.svg)](https://github.com/amrutsoftware/ci-cd-with-actions/actions/workflows/ci.yml)
